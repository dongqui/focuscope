...
extension GetPlanetCollection on Isar {
  IsarCollection<Planet> get planets => this.collection();
}

const PlanetSchema = CollectionSchema(
  name: r'Planet',
  ...
  estimateSize: _planetEstimateSize,
  serialize: _planetSerialize,
  deserialize: _planetDeserialize,
  deserializeProp: _planetDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _planetGetId,
  getLinks: _planetGetLinks,
  attach: _planetAttach,
  version: '3.1.0+1',
);

int _planetEstimateSize(
  Planet object,
  List<int> offsets,
...
Id _planetGetId(Planet object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _planetGetLinks(Planet object) {
  return [];
}

void _planetAttach(IsarCollection<dynamic> col, Id id, Planet object) {
  object.id = id;
}

extension PlanetQueryWhereSort on QueryBuilder<Planet, Planet, QWhere> {
  QueryBuilder<Planet, Planet, QAfterWhere> anyId() {
...
extension PlanetQueryWhere on QueryBuilder<Planet, Planet, QWhereClause> {
  QueryBuilder<Planet, Planet, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Planet, Planet, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension PlanetQueryFilter on QueryBuilder<Planet, Planet, QFilterCondition> {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> idGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Planet, Planet, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension PlanetQueryObject on QueryBuilder<Planet, Planet, QFilterCondition> {}
...
extension PlanetQuerySortBy on QueryBuilder<Planet, Planet, QSortBy> {
  ...
  QueryBuilder<Planet, Planet, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanetQuerySortThenBy on QueryBuilder<Planet, Planet, QSortThenBy> {
  QueryBuilder<Planet, Planet, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<Planet, Planet, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, Planet, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension PlanetQueryWhereDistinct on QueryBuilder<Planet, Planet, QDistinct> {
  ...
  QueryBuilder<Planet, Planet, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PlanetQueryProperty on QueryBuilder<Planet, Planet, QQueryProperty> {
  QueryBuilder<Planet, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Planet, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
